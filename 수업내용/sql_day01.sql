...
7902	FORD	ANALYST	
7934	MILLER	CLERK	
==> 숫자값과 (null) 값의 산술 연산 결과는 결국 (null) 임을 주의하자
*/
...
--- LIKE 연산자 : 유사 값을 검색하는 데 사용
/* LIKE 연산자는 유사값 검색을 위한 함께 사용하는 패턴 인식 문자가 있다.
...
;
-- 이름의 둘째 자리부터 LA 가 들어가는 직원의 사번, 이름 조회
SELECT e.EMPNO
     , e.ENAME
  FROM emp e
